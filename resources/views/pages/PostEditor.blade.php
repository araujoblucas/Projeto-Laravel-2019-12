    ...
    <body>
        ...
        <div class="container">
           ...
           @endcomponent
            ...
            <form class="containerContentHeader" method="Post" action="{{ route('PostUpdater', $post->id) }}">
                {{method_field('PUT')}} {{csrf_field()}}
                <div class="titleBox">
                    <p class="titleSection">Editar Post</p>
                ...
                <div class="contentHead">
                    ...
                    <div class="box" style="margin-bottom: 20px;">
                        ...
                        <input type="text" name="autor" value="{{$post->autor}}"/>
                    </div>
