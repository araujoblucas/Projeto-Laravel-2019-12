...
<div class="attorna-body-outer-wrapper ">
    ...
    <div class=attorna-page-wrapper id=attorna-page-wrapper>
        <div class=gdlr-core-page-builder-body>
            ...
            <div class="gdlr-core-pbf-wrapper " style="padding: 95px 0px 30px 0px;" id=gdlr-core-wrapper-2>
                                    ...
                                    <div class=gdlr-core-pbf-element>
                                        <div class="gdlr-core-video-item gdlr-core-item-pdlr gdlr-core-item-pdb ">
                                            <div class=gdlr-core-video-item-type-youtube>
                                                <iframe src="{{$dados->video}}" width=640 height=360 data-player-type=youtube allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=gdlr-core-pbf-element>
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style="padding-bottom: 35px ;">
                                            <div class="gdlr-core-title-item-title-wrap ">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 20px ;font-weight: 700 ;letter-spacing: 0px ;text-transform: none ;color: #2f2f2f ;">{{$dados->tituloVideo}}<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3></div><span class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-style: normal ;">{{$dados->descVideo}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="gdlr-core-accordion-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-accordion-style-icon gdlr-core-allow-close-all">
                                            <div class="gdlr-core-accordion-item-tab clearfix  gdlr-core-active">
                                                ...
                                                <div class=gdlr-core-accordion-item-content-wrapper>
                                                    <h4 class="gdlr-core-accordion-item-title gdlr-core-js " style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">{{$dados->ask1}}</h4>
                                            ...
                                            <div class="gdlr-core-accordion-item-tab clearfix ">
                                                <div class="gdlr-core-accordion-item-icon gdlr-core-js gdlr-core-skin-icon "></div>
                                                <div class=gdlr-core-accordion-item-content-wrapper>
                                                    <h4 class="gdlr-core-accordion-item-title gdlr-core-js " style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">{{$dados->ask2}}</h4>
                                                    <div class=gdlr-core-accordion-item-content>
                                                        <p>{{$dados->answer2}}</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="gdlr-core-accordion-item-tab clearfix ">
                                                <div class="gdlr-core-accordion-item-icon gdlr-core-js gdlr-core-skin-icon "></div>
                                                <div class=gdlr-core-accordion-item-content-wrapper>
                                                    <h4 class="gdlr-core-accordion-item-title gdlr-core-js " style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">{{$dados->ask3}}</h4>
                                                    <div class=gdlr-core-accordion-item-content>
                                                        <p>{{$dados->answer3}}</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="gdlr-core-accordion-item-tab clearfix ">
                                                <div class="gdlr-core-accordion-item-icon gdlr-core-js gdlr-core-skin-icon "></div>
                                                <div class=gdlr-core-accordion-item-content-wrapper>
                                                    <h4 class="gdlr-core-accordion-item-title gdlr-core-js " style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">{{$dados->ask4}}</h4>
                                                    <div class=gdlr-core-accordion-item-content>
                                                        <p>{{$dados->answer4}}</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="gdlr-core-accordion-item-tab clearfix ">
                                                <div class="gdlr-core-accordion-item-icon gdlr-core-js gdlr-core-skin-icon "></div>
                                                <div class=gdlr-core-accordion-item-content-wrapper>
                                                    <h4 class="gdlr-core-accordion-item-title gdlr-core-js " style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">{{$dados->ask5}}</h4>
                                                    <div class=gdlr-core-accordion-item-content>
                                                        <p>{{$dados->answer5}}</p>
                                                    </div>
                                                </div>
