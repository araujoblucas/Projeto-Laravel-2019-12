    ...
    <table class="table" style="width:60%;margin-top: 20px;">
        ...
        @foreach( $posts as $post)
            ...
            <tr style="text-transform:capitalize;">
                ...
                <td scope="row" style="text-align: center"><a href="{{route('AdminPostShow', $post->id)}}"><i
                            class="fa fa-eye" style="font-size:24px; color:#000;"></i></a></td>
                <td scope="row" style="text-align: center"><a href="{{route('PostEditor', $post->id)}}"><i
                            class="fas fa-edit" style="font-size:24px;color:black; "></i></a></td>
                <td scope="row" style="text-align: center"><a href="{{route('postDelete', $post->id)}}"><i
