...
class CreateAboutTeamsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('about_teams', function (Blueprint $table) {
            ...
            $table->string('ask1', 500);
            $table->string('answer1', 500);
            $table->string('ask2', 500);
            $table->string('answer2', 500);
            $table->string('ask3', 500);
            $table->string('answer3', 500);
            $table->string('ask4', 500);
            $table->string('answer4', 500);
            $table->string('ask5', 500);
            $table->string('answer5', 500);
            $table->string('video', 500);
            $table->string('descVideo', 500);
            $table->string('tituloVideo', 500);
